...
variable "billing_reconciler_service_account_name" {
  ...
  type        = string
  default     = "agentic10-reconciler-sa"
}
...
variable "pubsub_topic_name" {
  ...
  type        = string
  default     = "agent-turn-events-agentic10"
}
...
variable "firestore_idempotency_collection" {
  ...
  type        = string
  default     = "processed_events_agentic10"
}
...
variable "firestore_billing_ledger_collection" {
  ...
  type        = string
  default     = "agent_billing_ledger_agentic10"
}
...
variable "firestore_customer_wallets_collection" {
  ...
  type        = string
  default     = "customer_wallets_agentic10"
}
...
variable "firestore_billing_reservations_collection" {
  ...
  type        = string
  default     = "billing_reservations_agentic10"
}
...
variable "firestore_wallet_transactions_collection" {
  ...
  type        = string
  default     = "wallet_transactions_agentic10"
}
...
variable "firestore_customer_billing_periods_collection" {
  ...
  type        = string
  default     = "customer_billing_periods_agentic10"
}
...
variable "firestore_customer_billing_accounts_collection" {
  ...
  type        = string
  default     = "customer_billing_accounts_agentic10"
}
...
variable "firestore_stripe_webhook_events_collection" {
  ...
  type        = string
  default     = "stripe_webhook_events_agentic10"
}
...
variable "billing_api_stripe_webhook_signing_secret_id" {
  ...
  type        = string
  default     = "stripe-webhook-signing-secret-agentic10"
}
...
variable "deployment_environment" {
  description = "Deployment stage used for production-only safety checks in the Cloud Shell deploy script."
  type        = string
  default     = "development"
...
variable "billing_cancellation_reconciliation_batch_size" {
  description = "Maximum cancellation intents processed by one billing reconciliation request."
  type        = number
  default     = 5

  validation {
    condition     = var.billing_cancellation_reconciliation_batch_size >= 1 && var.billing_cancellation_reconciliation_batch_size <= 5
    error_message = "billing_cancellation_reconciliation_batch_size must be between 1 and 5 to stay within the Scheduler request deadline."
  }
}
...
variable "firestore_subscription_cancellation_requests_collection" {
  ...
  type        = string
  default     = "subscription_cancellation_requests_agentic10"
}
